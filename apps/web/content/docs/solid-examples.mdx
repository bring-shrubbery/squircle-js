...
New to the package? Start with [Getting Started](/docs/solid-getting-started), then read [Corner Smoothing Explained](/docs/solid-corner-smoothing) to understand the `cornerSmoothing` values used below.

## Button

Using `asChild` renders the squircle clip-path directly on the `button` element with no extra wrapper:

<LiveExample framework="solid" example="button" height={120} />
...
<LiveExample framework="solid" example="card" height={220} />
...
<LiveExample framework="solid" example="avatar" height={160} />
...
<LiveExample framework="solid" example="image-container" height={460} />
...
<LiveExample framework="solid" example="app-icon" height={180} />
...
<LiveExample framework="solid" example="notification-badge" height={80} />
...
<LiveExample framework="solid" example="motion-card" height={220} />
...
<LiveExample framework="solid" example="icon-button" height={100} />
...
<LiveExample framework="solid" example="reactive-squircle" height={200} />
...
<LiveExample framework="solid" example="list-of-squircles" height={120} />
