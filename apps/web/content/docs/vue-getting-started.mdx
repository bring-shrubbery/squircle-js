...
- [Examples & Recipes](/docs/vue-examples) — copy-paste patterns for buttons, cards, avatars, and app icons.
- [Corner Smoothing Explained](/docs/vue-corner-smoothing) — what the `cornerSmoothing` values mean and which to pick.
- [The Squircle Component](/docs/vue-squircle-component) — full prop reference and `ResizeObserver` behavior.
