...
New to the package? Start with [Getting Started](/docs/svelte-getting-started), then read [Corner Smoothing Explained](/docs/svelte-corner-smoothing) to understand the `cornerSmoothing` values used below.
