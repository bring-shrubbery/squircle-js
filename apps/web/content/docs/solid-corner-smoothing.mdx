...
- [Getting Started](/docs/solid-getting-started) — install `@squircle-js/solid` and render your first squircle.
- [Examples & Recipes](/docs/solid-examples) — see these smoothing values applied to real components.
