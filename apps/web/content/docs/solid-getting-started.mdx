...
- [Examples & Recipes](/docs/solid-examples) — copy-paste patterns for buttons, cards, avatars, and app icons.
- [Corner Smoothing Explained](/docs/solid-corner-smoothing) — what the `cornerSmoothing` values mean and which to pick.
- [The Squircle Component](/docs/solid-squircle-component) — full prop reference and `ResizeObserver` behavior.
