...
- [Getting Started](/docs/svelte-getting-started) — install `@squircle-js/svelte` and render your first squircle.
- [Examples & Recipes](/docs/svelte-examples) — see these smoothing values applied to real components.
