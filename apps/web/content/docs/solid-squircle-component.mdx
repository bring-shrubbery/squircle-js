...
- [Corner Smoothing Explained](/docs/solid-corner-smoothing) — tune the `cornerSmoothing` prop from `0` to `1`.
- [Examples & Recipes](/docs/solid-examples) — `Squircle` in real button, card, and avatar patterns.
