...
New to the package? Start with [Getting Started](/docs/vue-getting-started), then read [Corner Smoothing Explained](/docs/vue-corner-smoothing) to understand the `cornerSmoothing` values used below.
