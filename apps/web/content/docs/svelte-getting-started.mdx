...
- [Examples & Recipes](/docs/svelte-examples) — copy-paste patterns for buttons, cards, avatars, and app icons.
- [StaticSquircle](/docs/svelte-static-squircle) — skip the observer for elements with known dimensions.
- [Corner Smoothing Explained](/docs/svelte-corner-smoothing) — what the `cornerSmoothing` values mean and which to pick.
