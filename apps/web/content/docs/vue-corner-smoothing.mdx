...
- [Getting Started](/docs/vue-getting-started) — install `@squircle-js/vue` and render your first squircle.
- [Examples & Recipes](/docs/vue-examples) — see these smoothing values applied to real components.
