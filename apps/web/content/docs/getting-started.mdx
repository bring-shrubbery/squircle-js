...
If you're building with Solid.js, check out [Getting Started (Solid)](/docs/solid-getting-started) — `@squircle-js/solid` mirrors this API with a small set of framework-specific adjustments.
