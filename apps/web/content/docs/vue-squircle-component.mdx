...
- [Corner Smoothing Explained](/docs/vue-corner-smoothing) — tune the `cornerSmoothing` prop from `0` to `1`.
- [Examples & Recipes](/docs/vue-examples) — `<Squircle>` in real button, card, and avatar patterns.
